            ...
            <div key={course.id} style={{background:'white',borderRadius:'1rem',overflow:'hidden',boxShadow:'0 4px 6px rgba(0,0,0,0.1)'}}>
              ...
              <div style={{padding:'1.25rem'}}>
                ...
                <div style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
                  <span style={{fontSize:'1.25rem',fontWeight:800,color:'#2563eb'}}>₹{course.currentPrice||0}</span>
                  <button onClick={()=>handleEnroll(course)} disabled={enrollingId===course.id} style={{background:'#2563eb',color:'white',border:'none',padding:'0.5rem 1rem',borderRadius:'0.5rem',cursor:'pointer'}}>
